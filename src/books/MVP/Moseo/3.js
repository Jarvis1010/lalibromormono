export const CxapitroTri = {
  ...
  verses: [
    ...
    "11 Kaj mi, la Eternulo, donis al la unua la nomon Piŝon, kaj ĝi ĉirkaŭas la tutan landon Ĥavila, kie mi, la Eternulo, kreis multe da oro;",
    "12 Kaj la oro de tiu lando estis bona, kaj tie troviĝis bedelio kaj la ŝtono onikso.",
    "13 Kaj la dua rivero estis nomita Giĥon; ĝi estas tiu, kiu ĉirkaŭas la tutan landon Etiopujo.",
    "14 Kaj la nomo de la tria rivero estis Ĥidekel; ĝi estas tiu, kiu fluas al la oriento de Asirio. Kaj la kvara rivero estis Eŭfrato.",
